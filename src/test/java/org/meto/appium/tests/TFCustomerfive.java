...
public class TFCustomerfive extends TestBase {
	FormLogin formLogin;
	...
	@Test
	public void Customerfive() throws InterruptedException{
		FormCustomerfive formCustomerfive = new FormCustomerfive(driver);
		formCustomerfive.Customerup();
		
		formCustomerfive.fotoExperian();
		formCustomerfive.fotofrenteDni();
		formCustomerfive.fotoreversoDni();
		formCustomerfive.fotoCliente();
		formCustomerfive.saveCustomer();
		formCustomerfive.swipeScreenOneCustomer();
		
	    FormBusinessfive formBusinessfive = formCustomerfive.nextCustomerfive();
