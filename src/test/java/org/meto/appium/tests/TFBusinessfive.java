...
public class TFBusinessfive extends TestBase{
	FormLogin formLogin;
	...
	@Test
	public void TestBusinessfive() throws InterruptedException{
		FormBusinessfive formBusinessfive = new FormBusinessfive(driver);
		formBusinessfive.photoSelfie();
		formBusinessfive.saveBusiness();
		
		FormRsefive formRsefive = formBusinessfive.nextBusinessfive();
