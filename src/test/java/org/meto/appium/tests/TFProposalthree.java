...
public class TFProposalthree extends TestBase{
	FormLogin formLogin;
	...
	@Test
	public void TestProposalthree() throws InterruptedException{
		//FormProspect formProspect = formPage.localButtom();
		FormProposalthree formProposalthree = new FormProposalthree(driver);
	//	formProposal.amountguarantor("1500");
		formProposalthree.debtBtn();
	//	formProposaltwo.producto();
		formProposalthree.savePropos();
	
		FormContractthree formContractthree = formProposalthree.saveProposal();
