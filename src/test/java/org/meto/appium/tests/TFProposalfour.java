...
public class TFProposalfour extends TestBase{
	FormLogin formLogin;
	...
	@Test
	public void TestProposalfour() throws InterruptedException{
		//FormProspect formProspect = formPage.localButtom();
		FormProposalfour formProposalfour = new FormProposalfour(driver);
	//	formProposal.amountguarantor("1500");
		formProposalfour.debtBtn();
	//	formProposaltwo.producto();
		formProposalfour.savePropos();
	
		FormContractfour formContractfour = formProposalfour.saveProposal();
