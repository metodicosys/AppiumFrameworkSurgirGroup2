...
public class TFRsesix extends TestBase{
	...
	//  FormContract formContract;
	  ...
	  @Test public void TestRsesix() throws InterruptedException{ 
		  FormRsesix formRsesix = new FormRsesix(driver);
		  
		  formRsesix.autoComplit(); 
		  formRsesix.giro("VE"); 
		 // formRse.activeC1("10");
		...
		//  formRse.btnNextRse();
		  ...
		  FormProposalsix formProposalsix = formRsesix.btnNextRsef();
