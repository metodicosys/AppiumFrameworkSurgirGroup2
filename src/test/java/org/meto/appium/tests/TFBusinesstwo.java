...
public class TFBusinesstwo extends TestBase{
	FormLogin formLogin;
	...
	@Test
	public void TestBusinesstwo() throws InterruptedException{
		FormBusinesstwo formBusinesstwo = new FormBusinesstwo(driver);
		formBusinesstwo.Businessup();
		
		formBusinesstwo.photoSelfie();
		formBusinesstwo.saveBusiness();
		
		FormRsetwo formRsetwo = formBusinesstwo.nextBusiness();
