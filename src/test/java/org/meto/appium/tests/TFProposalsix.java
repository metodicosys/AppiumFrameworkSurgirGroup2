...
import org.meto.appium.pages.FormProposalsix;
...
public class TFProposalsix extends TestBase{
	FormLogin formLogin;
	...
	FormProposalsix formProposalsix;
	...
	public void beforeMethod(Method method) {
		...
		formProposalsix = new FormProposalsix(driver);
		formContractsix = new FormContractsix(driver);
		
	}
	
	@Test
	public void TestProposalsix() throws InterruptedException{
		FormProposalsix formProposalsix = new FormProposalsix(driver);
	//	formProposal.amountguarantor("1500");
		formProposalsix.debtBtn();
	//	formProposaltwo.producto();
		formProposalsix.savePropos();
	
		FormContractsix formContractsix = formProposalsix.saveProposal();
