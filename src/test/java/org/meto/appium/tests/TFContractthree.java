...
public class TFContractthree extends TestBase{
	FormLogin formLogin;
	...
	@Test
	public void TestContractthree() throws InterruptedException{
		//FormProspect formProspect = formPage.localButtom();
		FormContractthree formContractthree = new FormContractthree(driver);
		
		formContractthree.formaPago();
		formContractthree.financialEntity();
	...
	//	formContracttwo.upcontact();
		formContractthree.customerListn();//nuevo listando
		formContractthree.customerPage2();
	//	formContract.saveContract();
		...
		FormCustomerfour formCustomerfour = formContractthree.bsaveContract();
