...
public class TFProposaltwo extends TestBase{
	FormLogin formLogin;
	...
	@Test
	public void TestProposaltwo() throws InterruptedException{
		//FormProspect formProspect = formPage.localButtom();
		FormProposaltwo formProposaltwo = new FormProposaltwo(driver);
		formProposaltwo.Proposalup();
	//	formProposal.amountguarantor("1500");
		formProposaltwo.debtBtn();
	//	formProposaltwo.producto();
		formProposaltwo.swipeScreenOneProposaltwo();
		formProposaltwo.savePropos();
	
		FormContracttwo formContracttwo = formProposaltwo.saveProposal();
