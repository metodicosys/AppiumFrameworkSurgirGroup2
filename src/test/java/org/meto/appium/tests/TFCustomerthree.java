...
public class TFCustomerthree extends TestBase {
	FormLogin formLogin;
	...
	@Test
	public void TestCustomerthree() throws InterruptedException{
		FormCustomerthree formCustomerthree = new FormCustomerthree(driver);
		formCustomerthree.Customerup();
		
		formCustomerthree.fotoExperian();
		formCustomerthree.fotofrenteDni();
		formCustomerthree.fotoreversoDni();
		formCustomerthree.fotoCliente();
		formCustomerthree.saveCustomer();
	//	formCustomerthree.swipeScreenOneCustomer();
		
		FormBusinessthree formBusinessthree = formCustomerthree.nextCustomerthree();
