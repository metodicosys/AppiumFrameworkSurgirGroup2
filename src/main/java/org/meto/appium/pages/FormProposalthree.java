...
public class FormProposalthree extends AndroidActions{

	AndroidDriver driver;
	private String dsegmento;
	
	public FormProposalthree(AndroidDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public FormProposalthree debtBtn() throws InterruptedException {
		deudab.click();
		Thread.sleep(4000);
		return this;
	...
	public FormProposalthree producto() throws InterruptedException {
		mdesp.click();
		product();
		Thread.sleep(5000);
		return this;
	...
	public FormProposalthree savePropos() throws InterruptedException {
		saveprop.click();
		Thread.sleep(1000);
		return this;
	...
	public FormContractthree saveProposal() throws InterruptedException  {
		nextprop.click();
		Thread.sleep(1000);
		return new FormContractthree(driver);
