...
public class FormContractthree extends AndroidActions{

	AndroidDriver driver;
	
	public FormContractthree(AndroidDriver driver) {
		super(driver);
		this.driver = driver;
	...
	private WebElement listCustom3;
	...
	public FormContractthree formaPago() throws InterruptedException {
		fpago.click();
		Thread.sleep(1000);
		formadePago();
		return this;
	...
	public FormContractthree financialEntity() {
		entFinan.click();
		entidadFinanciera();
		return this;
	...
	public FormContractthree nextOneContract() {
	...
	public void customerListn() throws InterruptedException {
		Thread.sleep(4000);
		listCustom3.click(); //click en la lista
		listaCliente4(); //aki debe selccionar una de la lista segun la condición
		
	}
		
	
	// Pasa a tab cliente
	public FormContractthree customerPage2() throws InterruptedException {
		Thread.sleep(3000);
		return this;
	...
	public FormContractthree saveContract() {
		savecontr.click();
		return this;
	...
	public FormCustomerfour bsaveContract() throws InterruptedException {
		Thread.sleep(1000);
