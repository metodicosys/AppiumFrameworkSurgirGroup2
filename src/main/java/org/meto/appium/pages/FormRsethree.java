...
public class FormRsethree extends AndroidActions{
	
	AndroidDriver driver;
	
	public FormRsethree(AndroidDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public FormRsethree autoComplit() {
		autoc.click();
		return this;
		
	}
	
	public FormRsethree giro(String girotext) {
	...
	public FormRsethree activeC1(String active1) {
		activeone.sendKeys(active1);
		return this;
		
	}
	
	public FormRsethree saveRse() {
		btnrse.click();
		return this;
		
	}
	
	public FormProposalthree btnNextRse() throws InterruptedException  {
		btnextrse.click();
		return new FormProposalthree(driver);
