...
public class FormCustomerthree extends AndroidActions{

	AndroidDriver driver;
	
	public FormCustomerthree(AndroidDriver driver) {
		super(driver);
		this.driver = driver;
...
//	WebElement newmember;
	...
	public FormBusinessthree nextCustomerthree() throws InterruptedException  {
		nextcust.click();
		return new FormBusinessthree(driver);
	...
	public FormCustomerthree saveCustomer() {
		savecustom.click();
		return this;
	...
	public FormCustomerthree bcontinuarValid() {
	...
	public FormCustomerthree bsaveContract() {
