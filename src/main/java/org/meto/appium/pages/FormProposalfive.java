...
public class FormProposalfive extends AndroidActions{

	AndroidDriver driver;
	private String dsegmento;
	
	public FormProposalfive(AndroidDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public FormProposalfive debtBtn() {
		deudab.click();
		return this;
		
	}
	
	public FormProposalfive producto() throws InterruptedException {
		mdesp.click();
		product();
		Thread.sleep(15000);
		return this;
	...
	public FormProposalfive savePropos() throws InterruptedException {
		saveprop.click();
		Thread.sleep(1000);
		return this;
	...
	public FormContractfive saveProposal() throws InterruptedException  {
		nextprop.click();
		Thread.sleep(1000);
		return new FormContractfive(driver);
