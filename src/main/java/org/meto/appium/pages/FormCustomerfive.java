...
public class FormCustomerfive extends AndroidActions{

	AndroidDriver driver;
	
	public FormCustomerfive(AndroidDriver driver) {
		super(driver);
		this.driver = driver;
...
//	WebElement newmember;
	...
	public FormBusinessfive nextCustomerfive() throws InterruptedException  {
		nextcust.click();
		return new FormBusinessfive(driver);
	...
	public FormCustomerfive saveCustomer() {
		savecustom.click();
		return this;
	...
	public FormCustomerfive bcontinuarValid() {
	...
	public FormCustomerfive bsaveContract() {
