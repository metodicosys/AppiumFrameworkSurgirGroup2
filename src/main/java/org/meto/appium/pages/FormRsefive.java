...
public class FormRsefive extends AndroidActions{
	
	AndroidDriver driver;
	
	public FormRsefive(AndroidDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public FormRsefive autoComplit() {
		autoc.click();
		return this;
		
	}
	
	public FormRsefive giro(String girotext) {
	...
	public FormRsefive activeC1(String active1) {
		activeone.sendKeys(active1);
		return this;
		
	}
	
	public FormRsefive saveRse() {
		btnrse.click();
		return this;
		
	}
	
	public FormProposalfive btnNextRsef() throws InterruptedException  {
		btnextrse.click();
		return new FormProposalfive(driver);
