...
public class FormBusinesssix extends AndroidActions{
	AndroidDriver driver;
	
	public FormBusinesssix(AndroidDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public FormBusinesssix BussinesP() {
		businessp.click();
		return this;

	}
	
	public FormBusinesssix photoSelfie() {
	//	Thread.sleep(5000);
		fotonegocio.click();
		fotonegocio.click();
		fotoSelfie();
	...
	public FormBusinesssix saveBusiness() {
		savenegocio.click();
		return this;
		
	}
	
	public FormRsesix nextBusinesssix() throws InterruptedException  {
		nextnegociof.click();
		return new FormRsesix(driver);
