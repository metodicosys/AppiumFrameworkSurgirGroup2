...
public class FormCustomersix extends AndroidActions{

	AndroidDriver driver;
	
	public FormCustomersix(AndroidDriver driver) {
		super(driver);
		this.driver = driver;
...
//	WebElement newmember;
	...
	public FormBusinesssix nextCustomersix() throws InterruptedException  {
		nextcust.click();
		return new FormBusinesssix(driver);
	...
	public FormCustomersix saveCustomer() {
		savecustom.click();
		return this;
	...
	public FormCustomersix bcontinuarValid() {
	...
	public FormCustomersix bsaveContract() {
