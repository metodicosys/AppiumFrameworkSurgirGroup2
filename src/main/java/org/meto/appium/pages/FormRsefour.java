...
public class FormRsefour extends AndroidActions{
	
	AndroidDriver driver;
	
	public FormRsefour(AndroidDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public FormRsefour autoComplit() {
		autoc.click();
		return this;
		
	}
	
	public FormRsefour giro(String girotext) {
	...
	public FormRsefour activeC1(String active1) {
		activeone.sendKeys(active1);
		return this;
		
	}
	
	public FormRsefour saveRse() {
		btnrse.click();
		return this;
		
	}
	
	public FormProposalfour btnNextRsef() throws InterruptedException  {
		btnextrse.click();
		return new FormProposalfour(driver);
