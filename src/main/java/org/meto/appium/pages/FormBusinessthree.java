...
public class FormBusinessthree extends AndroidActions{
	AndroidDriver driver;
	
	public FormBusinessthree(AndroidDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public FormBusinessthree BussinesP() {
		businessp.click();
		return this;

	}
	
	public FormBusinessthree photoSelfie() {
	//	Thread.sleep(5000);
		fotonegocio.click();
		fotonegocio.click();
		fotoSelfie();
	...
	public FormBusinessthree saveBusiness() {
		savenegocio.click();
		return this;
		
	}
	
	public FormRsethree nextBusiness() throws InterruptedException  {
		nextnegocio.click();
		return new FormRsethree(driver);
