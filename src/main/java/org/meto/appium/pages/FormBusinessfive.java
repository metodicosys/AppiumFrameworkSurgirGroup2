...
public class FormBusinessfive extends AndroidActions{
	AndroidDriver driver;
	
	public FormBusinessfive(AndroidDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public FormBusinessfive BussinesP() {
		businessp.click();
		return this;

	}
	
	public FormBusinessfive photoSelfie() {
	//	Thread.sleep(5000);
		fotonegocio.click();
		fotonegocio.click();
		fotoSelfie();
	...
	public FormBusinessfive saveBusiness() {
		savenegocio.click();
		return this;
		
	}
	
	public FormRsefive nextBusinessfive() throws InterruptedException  {
		nextnegociof.click();
		return new FormRsefive(driver);
