...
public class FormProposalsix extends AndroidActions{

	AndroidDriver driver;
	private String dsegmento;
	
	public FormProposalsix(AndroidDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public FormProposalsix debtBtn() {
		deudab.click();
		return this;
		
	}
	
	public FormProposalsix producto() throws InterruptedException {
		mdesp.click();
		product();
		Thread.sleep(15000);
		return this;
	...
	public FormProposalsix savePropos() throws InterruptedException {
		saveprop.click();
		Thread.sleep(1000);
		return this;
	...
	public FormContractsix saveProposal() throws InterruptedException  {
		nextprop.click();
		Thread.sleep(1000);
		return new FormContractsix(driver);
